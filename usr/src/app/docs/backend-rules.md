...
In Ethiopia, interpretation of law is often governed by binding decisions from the Federal Supreme Court Cassation Bench. Templates must reflect this.
  ...
  * **1.4. Relief for Costs:** Templates SHOULD include a standard, non-dynamic relief option for the payment of court costs and advocate fees, allowing the user to request this common judgment.
...
### 4\. Bilingual Supremacy & Amharic-Only Output
  ...
  * **4.3. Amharic-Only Output:** The final rendered document (the preview pane) MUST be 100% Amharic. No English words or non-standard symbols (e.g., '%') are permitted. Numbers must be spelled out in Amharic script (e.g., `(አስር ሺህ ብር)`).
  * **4.4. Modern Numerals:** All legal article, proclamation, and other reference numbers must be rendered using modern Arabic numerals (e.g., "123", "2024") instead of Geez numerals (e.g., "፻፳፫", "፪ሺ፳፬").
...
### 5\. Zero-Typing variable Injection
  ...
  * **5.3. Guiding Amharic Placeholders:** All input field watermarks in the editor UI must be in clear, guiding Amharic and provide illustrative examples to the user (e.g., `ለምሳሌ፦ የካቲት 15፣ 2016 ዓ.ም.`).
  ...
  "templates": [
    {
      ...
      "jurisdictionText": "Revised Family Code Proclamation No. 213/2000, Article 77 (የተሻሻለው የቤተሰብ ሕግ አዋጅ ቁጥር ፪፻፲፫/፲ᱺ፱፻፺፪ አንቀጽ ፸፯)",
      "meta": {
...
3.  **[ ] Citation Check:** Do the Article numbers actually match the text in the Proclamation? Are they blended naturally into the text?
